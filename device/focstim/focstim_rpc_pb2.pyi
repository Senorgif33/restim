from . import notifications_pb2 as _notifications_pb2
...
class Notification(_message.Message):
    ...
    NOTIFICATION_HALL_GIRTH_FIELD_NUMBER: _ClassVar[int]
    ...
    notification_hall_girth: _notifications_pb2.NotificationHallGirth
