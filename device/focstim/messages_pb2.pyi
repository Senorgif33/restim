...
class ResponseCapabilitiesGet(_message.Message):
    ...
    lsm6dsox: bool
    def __init__(self, threephase: _Optional[bool] = ..., fourphase: _Optional[bool] = ..., battery: _Optional[bool] = ..., device_volume: _Optional[bool] = ..., maximum_waveform_amplitude_amps: _Optional[float] = ..., lsm6dsox: _Optional[bool] = ...) -> None: ...
...
class RequestAxisSet(_message.Message):
    ...
    value: float
    clear: bool
    def __init__(self, axis: _Optional[_Union[_constants_pb2.AxisType, str]] = ..., timestamp_ms: _Optional[int] = ..., value: _Optional[float] = ..., clear: _Optional[bool] = ...) -> None: ...
...
class RequestLockDeviceVolume(_message.Message):
    ...
    lock: bool
    def __init__(self, lock: _Optional[bool] = ...) -> None: ...
